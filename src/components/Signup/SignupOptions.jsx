    ...
    <div className="signup">
      ...
      <main className="signup__container container--pall">
        <div className="signup__tabs-container">
          ...
          <h3 className="signup__subtitle">Please select an option below.</h3>

          <div className="signup__tabs">
            <div className="tab">
              <div className="tab__btn-container">
                <TabButton text="I'm A Business" tabIndex={0} onClick={0 * 2} />
              ...
              <div className="tab__container hidden" tab-index="2">
                <div className="tab__container-text">
                  ...
                  <p>
                    ...
                    invitation from your client. We&#39;re looking forward to
                    seeing you soon.
                  </p>
                  <button
                  ...
                  >
                    <div className="learn-mencruit">Learn what MenCruit is</div>
                    <svg
                      focusable="false"
                      aria-hidden="true"
                      viewBox="0 0 24 24"
